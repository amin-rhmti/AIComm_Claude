...
\paragraph{Funding.}
This research was supported by funding from ETH Zurich and the University of Illinois Urbana-Champaign.

\paragraph{Conflict of interest.}
The authors have no conflict of interest to declare.

\paragraph{Ethics approval.}
The study was approved by the Institutional Review Board at the University of Illinois Urbana--Champaign (IRB24-0588).

\paragraph{Trial registration.}
This experiment was registered in the American Economic Association Registry for randomized controlled trials under trial number AEARCTR-0013548 (\url{https://www.socialscienceregistry.org/trials/13548}).

\paragraph{Use of AI tools.}
AI tools were used for text classification, language editing, and readability improvements during manuscript preparation. OpenAI's GPT-4o-mini model (accessed via the OpenAI API in December 2025) was used to assign categorical scores for meaningfulness of the post in the writing task. The authors take full responsibility for the final content of the manuscript.
...
\begin{table}[htbp]
    ...
    \label{tab:balance}
    \centering
    \resizebox{\textwidth}{!}{\input{balance}}
...
\scalebox{0.58}{\input{table_te_Finished_Full}}
