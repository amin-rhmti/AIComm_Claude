...
ttest Finished if sample2 == 1 & !missing(Finished), by(Identify) unequal
display "P-value for Finished: " %10.9f r(p)

ttest Post_meaningfulness if sample2 == 1 & !missing(Post_meaningfulness), by(Identify) unequal
display "P-value for Post_meaningfulness: " %10.9f r(p)
...
foreach s of local RUN_SAMPLES {
    ...
    // -------------------------------------------------------------------------
    foreach x in Finished Post_meaningfulness index_Post_effort index_Post_nlp Post_TextLength_log TimePost_W {
    ...
    // PART B: HTE CI plots
    // -------------------------------------------------------------------------
    foreach x in Finished Post_meaningfulness index_Post_effort index_Post_nlp {
